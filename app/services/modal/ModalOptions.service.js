...
(function () {
    ...
    angular.module('LoVendoApp.services')
        .factory('ModalOptions', ['$rootScope', 'SafetyFilter', 'GreatSchools', 'NearbyPlaces', ModalOptions]);
    ...
    function ModalOptions($rootScope, SafetyFilter, GreatSchools, NearbyPlaces) {
            ...
            return {
                ...
                resolve: {
                    ...
                    nearbyPlaces: function () {
                        //Making call to API
                        return NearbyPlaces.getNearbyPlaces(home.geo.lat, home.geo.lng, 500);
                    }
                }
            }
        }
